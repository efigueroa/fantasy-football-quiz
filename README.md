...
The clock is off and folded away until you want it. Open **Timer** at the bottom of the page and press **+30 sec** for each half minute you want to give a drafter. Adding time starts the clock and opens the panel, so **Pause** is one press away. Presses stack, **Pause** holds the time without losing it, and **Reset** clears it.
